...
`Smsd` defines Memory Protection Tables to set the access permissions for a memory
region or page associated with a supervisor domain, and an interface to program the configuration for
supervisor-domain-related extensions, 
