...
spaces with xwr permissions.
|2 |`Smmpt1bp34` |Page-based memory protection for up to 34-bit physical address
spaces with 1-bit permission.
|3 |- |`_Reserved_`
|===
...
spaces with xwr permissions.
|4 |`Smmpt1bp44` |Page-based memory protection for up to 44-bit physical address
spaces with 1-bit permission.
|5 |`Smmpt1bp53` |Page-based memory protection for up to 53-bit physical address
spaces.
|6 |`Smmpt1bp64` |Page-based memory protection for up to 64-bit physical address
spaces.
|7-15 |- |`_Reserved_`
|===
