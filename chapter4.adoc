...
If Smmptnapot is not implemented, bit 31 in a leaf MPTE remains reserved.
...
If Smmptnapot is not implemented, bit 63 in a leaf MPTE remains reserved. If
Smmptnlnapot is not implemented, bit 63 in a non-leaf MPTE remains reserved.
